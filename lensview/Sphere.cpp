...
Sphere::Sphere()
{
	Sphere(1.0, -1.0, 1.0, 2*M_PI, 1.0, Point(0,0,0));
}

Sphere::Sphere(float rad, float z0, float z1, float pm, float aper, Point c)
{
...
bool Sphere::Intersect(const Ray &r, float *tHit, Vector* n)
{
	float phi;
	Point phit;	
